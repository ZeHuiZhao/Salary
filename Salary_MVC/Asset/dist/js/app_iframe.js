...
function closeTabByPageId(pageId) {
    ...
    if ($title.hasClass("active")) {
        ...
        $('.sidebar-menu li').each(function(){
            if($(this).attr('data-id') == activePageId){
                $('.treeview.active').removeClass('active');
                $('.treeview-menu.menu-open').css({'display':'none'}).removeClass('menu-open');
                $(this).addClass('sel');
                $(this).parents('.treeview').addClass('active');
                $(this).parent().addClass('menu-open').css({ 'display': 'block' });
                //refreshTabById(activePageId)
