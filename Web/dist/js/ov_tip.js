...
TipBox.prototype.renderUI = function (tipType) {
    ...
    if (this.config.hasMask) {
        this.config.hasMaskWhite ? this._mask = $("<div class='mask_white'></div>") : this._mask = $("<div class='ov-mask'></div>");
...
function ErrorBox(str_message) {
    new TipBox({ type: 'error', str: str_message });
};

function SuccessBox(str_message) {
    new TipBox({ type: 'success', str: str_message });
};